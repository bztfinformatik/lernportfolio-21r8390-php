...
class OrderModel extends BaseModel
{
    ...
    public function getOrderData()
    {
     ...
     /**
     * getOrderDataInPipeline - Holt die Liste aller Bestellungen die noch nicht erledigt sind. Ziel: Auslastung der Mensa anzeigen
     *
     * @return $results - Array aus Bestellungen
     */
    public function getOrderDataInPipeline()
    {
